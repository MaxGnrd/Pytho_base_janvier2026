...
def menu():
    ...
    choix=int(choix)
    #on met "int" pour que ce qu'on écrive soit considéré pas comme un caractère mais le convertit en nombre entier.
...
def aire_cercle():
    ...
    rayon=float(rayon)
    aire=math.py*rayon**2
    print(f"L'aire de votre cercle vaut : {aire}")
    menu()
